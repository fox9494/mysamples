...
<link href="<c:url value='/resource/dwz/themes/default/style.css'/>" rel="stylesheet" type="text/css" />
<link href="<c:url value='/resource/dwz/themes/css/core.css'/>" rel="stylesheet" type="text/css" />
<link href="<c:url value='/resource/dwz/themes/css/print.css'/>" rel="stylesheet" type="text/css" />
<link href="<c:url value='/resource/dwz/uploadify/css/uploadify.css'/>" rel="stylesheet" type="text/css" />
<!--[if IE]>
...
<![endif]-->
<script src="<c:url value='/resource/dwz/js/jquery-1.7.2.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resource/dwz/js/jquery.cookie.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resource/dwz/js/jquery.validate.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resource/dwz/js/jquery.bgiframe.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resource/dwz/xheditor/xheditor-1.2.1.min.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resource/dwz/xheditor/xheditor_lang/zh-cn.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resource/dwz/uploadify/scripts/jquery.uploadify.js'/>" type="text/javascript"></script>


<!-- svg图表  supports Firefox 3.0+, Safari 3.0+, Chrome 5.0+, Opera 9.5+ and Internet Explorer 6.0+ -->
<script type="text/javascript" src="<c:url value='/resource/dwz/chart/raphael.js' />"></script>
<script type="text/javascript" src="<c:url value='/resource/dwz/chart/g.raphael.js' />"></script>
<script type="text/javascript" src="<c:url value='/resource/dwz/chart/g.bar.js' />"></script>
<script type="text/javascript" src="<c:url value='/resource/dwz/chart/g.line.js' />"></script>
<script type="text/javascript" src="<c:url value='/resource/dwz/chart/g.pie.js' />"></script>
<script type="text/javascript" src="<c:url value='/resource/dwz/chart/g.dot.js' />"></script>




<script type="text/javascript" src="<c:url value='/resource/dwz/js/dwz.min.js' />"></script>
<script type="text/javascript" src="<c:url value='/resource/dwz/js/dwz.regional.zh.js' />"></script>
