package com.institute.meeting.common.dao.impl;
...
//		}
	 ...
	 */
	@Deprecated
	public PageBean queryForPageByParams2(int pageSize, int page, String sql,Map<String,Object> params,Class<?> clazz) {
		SQLQuery query = getSession().createSQLQuery(sql);
