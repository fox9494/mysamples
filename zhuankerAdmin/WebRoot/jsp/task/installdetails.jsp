...
<html>
	...
	<body>  
		    ...
		    <form action="task/taskDetails!searchInstallDetails.shtml" method="post">		        
		        ...
		        <div class="search">
		         <ul>
		          <li>
		            <p>总安装量：</p><input type="text" value="<s:property value="pageBean.allRow"/>"/>
		           </li>
		          </ul>
		         </div>
		        <div class="list">
				<table cellspacing="0" border="0">
		              ...
		              <tbody id="listInstall">
		              <s:iterator value="pageBean.list" id="install">
		                <tr>
		                 <td><s:property value="#install.TUserClient.nickName"/></td>
		                 <td><s:property value="#install.TUserClient.userName"/></td>
		                 <td><s:date name="#install.operateDate" format="yyyy-MM-dd"/></td>
		                </tr>
		              </s:iterator>
		              </tbody>
		        </table>
		        <div class="">
		           ...
		           <s:if test="pageBean.allRow!=0">
		         	<div class="css" style="style">
						...
						一共有${pageBean.allRow}条记录 &nbsp;共${pageBean.totalPage}页&nbsp;当前是第<font id="showInstallCurrentPage">${pageBean.currentPage}</font>页
