...
<html>
  ...
  <div class="main" style="padding-top:20px;">
			<form action="<%=path %>/channel/channelAdd!addChannel.shtml" method="post"   id="addForm" name="channel"  >
			    <input id="parentId" name="channel.parent.id" value="<s:property value='parChannel.id'/>" type="hidden"> 
			    <input name="channel.levelCode" value="<s:property value='parChannel.levelCode'/>" type="hidden">
				<div class="form">
				<table cellspacing="0" border="0">
					<tr >
						...
						<td>
							<input name="channel.channelName" type="text" id="name" />
					...
					<tr>
						...
						<td>
						    <SELECT name="firstid" style="width:150px;" id="province">
						    	<option value="" onclick="javascript:select()">---请选择---</option>
						    	<s:iterator value="listArea" id="area">		    		
						    		<option value="<s:property value="#area.id"/>"><s:property value="#area.statename"/></option>
						    	</s:iterator>
						    </SELECT>
						    
						     <SELECT name="channel.TArea.id" style="width:150px;" id="city">
					...
					<tr>
						...
						<td>
							<input name="channel.contactPerson" type="text" id="contactPerson"/>
							<font color="red">&nbsp;<b>*</b>&nbsp;</font>
					...
					<tr>
						...
						<td>
							<input name="channel.mobile" type="text" id="mobile" onkeyup="if(isNaN(value))execCommand('undo')"/>
							<font color="red">&nbsp;<b>*</b>&nbsp;</font>
					...
					<tr>
						...
						<td>
							<input name="channel.email" type="text" id="email"/>
							<font color="red">&nbsp;<b>*</b>&nbsp;</font>
					...
					<tr>
						...
						<td>
							<input name="channel.TManagerInfo.userName" type="text" id="userName" />
							<font color="red">&nbsp;<b>*</b>&nbsp;</font>
					...
					<tr>
						...
						<td>
							<input name="channel.TManagerInfo.password" type="password" id="password"/>
							<font color="red">&nbsp;<b>*</b>&nbsp;</font>
					...
					<tr>
					    <td>确认密码:</td>
					    <td>
					        <input name="repassword" type="password" id="password"/>
							<font color="red">&nbsp;<b>*</b>&nbsp;</font>					    
					    </td>
					</tr>
