...
<html>
	...
	<body >
		<div class="main" style="padding-top:20px;">
			<form action="<%=path %>/admin/adminAdd.shtml" method="post" id="addForm">
				<div class="form">
					<table cellspacing="0" border="0">
						<tr>
						   <td class="title">用户姓名：</td>
						   <td><input name="manager.realName" type="text"  id="realName"   /></td>
						</tr>
						<tr>
						   <td>登录账号：</td>
						   <td><input name="manager.userName" type="text"  id="userName"   />
						   <font color="red"><s:fielderror fieldName="manager.userName"/></font>
						   </td>
						  
						<tr>
						    <td>用户角色：</td>
							<td> <select name="manager.TRoleInfo.id">
