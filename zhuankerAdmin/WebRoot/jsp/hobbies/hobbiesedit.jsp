...
<html>
  ...
  <body>
      <div class="main" style="padding-top:20px;">
       <form action="hobbies/hobbiesEdit!save.shtml" method="post" id="editForm">
          <input type="hidden" name="hobbies.hobbiesid" value="<s:property value="hobbies.hobbiesid"/>"/>
          <input type="hidden" name="hobbies.isRemove" value="<s:property value="hobbies.isRemove"/>"/>
          <div class="form">
