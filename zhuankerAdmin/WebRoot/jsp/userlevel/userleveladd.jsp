...
<html>
  ...
  <body>
      <div class="main" style="padding-top:20px;">
       <form action="userlevel/userLevelAdd!save.shtml" method="post" enctype="multipart/form-data" id="addForm">
        <div class="form">
         <table cellspacing="0" border="0">
              <tr>
                 ...
                 <td ><input type="text" name="userLevel.name" value="<s:property value="userLevel.name"/>"/>
                   <font color="red"><s:fielderror fieldName="userLevel.nameExist"/></font>
