...
<html>
  ...
  <body>
  	<br/>
    <div class="main">
    <form action="<%=path %>/reports/appInstallsStatistics.shtml" method="post" >
    <div class="ui-widget" >
    	<ul>  			
    ...
    <div class="list">
	    	<table cellspacing="0" border="0">
    			<tr class="head"> 			
     			...
     			<c:forEach items="${pageBean.list }" var="statisticsReport">
    				<tr>
						<td>${statisticsReport.companyName}</td>
						<td>${statisticsReport.appName}</td> 			  				
						<td>${statisticsReport.appInstalls}</td>
					</tr>
    			</c:forEach> 
    		</table>
    		<div >
