...
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('角色管理','com.guoxin.clientrole','0',3,'',null,'<img src="../images/1361617228_group.png">&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('客户管理','com.guoxin.client','0',4,'',null,'<img src="../images/1361617669_user1.png">&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('版本管理','com.guoxin.version','0',5,'',null,'<img src="../images/1361617203_book_open.png">&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('后台管理','com.guoxin.adminuser','0',6,'',null,'<img src="../images/1361617211_setting_tools.png">&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('类别管理','com.guoxin.category.list','0',1,'typeList!searchListPage.action',1,'<img src="../images/min-icon.png"/>&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('应用管理','com.guoxin.application.list','0',1,'../jsp/frame.jsp',2,'<img src="../images/min-icon.png"/>&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('角色管理','com.guoxin.clientrole.list','0',1,'roleList!searchListPage.action',3,'<img src="../images/min-icon.png"/>&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('角色应用','com.guoxin.clientrole.app','0',2,'roleAppList!searchListPage.action',3,'<img src="../images/min-icon.png"/>&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('客户管理','com.guoxin.client.list','0',1,'customerList!searchListPage.action',4,'<img src="../images/min-icon.png"/>&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('查看版本','com.guoxin.version.list','0',1,'searchLocalVerList!searchVersion.action',5,'<img src="../images/min-icon.png"/>&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('上传版本','com.guoxin.version.upload','0',2,'updateLocalVersion!initUpdateVersion.action',5,'<img src="../images/min-icon.png"/>&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('后台管理员','com.guoxin.adminuser.list','0',1,'adminuserList!searchListPage.action',6,'<img src="../images/min-icon.png"/>&nbsp;');
##insert into t_module(`name`,`code`,`type`,`order`,url,parentId,icon) values('权限分配','com.guoxin.adminuser.pri','0',2,'adminRoleList!searchAllRole.action',6,'<img src="../images/min-icon.png"/>&nbsp;');
